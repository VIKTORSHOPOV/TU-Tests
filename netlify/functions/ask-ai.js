...
exports.handler = async (event) => {
  ...
  const promptParts = [
    ...
    '',
    '### Definition (Max 1–2 sentences)',
    '<основно научно определение>',
    '',
    '### Key Exam Facts',
    '- <най-важен факт/приложение>',
    '- <кога или защо се използва>',
    '',
    '### Correct Answer Rationale',
    '- <1 кратко изречение обясняващо защо правилният избор е верен>',
    '',
    '### Exam Keywords',
    '<ключова дума 1>, <ключова дума 2>, <ключова дума 3>',
    '',
