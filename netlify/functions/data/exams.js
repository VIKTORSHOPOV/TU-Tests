...
,
  {
    id: "exam-pvs-2025-05-28",
category: "3.2 курс",
    title: "Изпит по дисциплината „Програмиране на вградени системи“",
    description: "Изпитен тест по вградени системи и AVR микроконтролери, 28.05.2025 г.",
    passwordHash: "",
    settings: {
      shuffleQuestions: false,
      shuffleChoices: false,
    ...
    questions: [
      {
        ...
        correctAnswer: "Специализирани компютърни системи за конкретна задача, вградени в устройство; използват се в техника, автомобили, домакински уреди, управление и автоматика.",
        scoring: { type: "text" }
      },
      {
        id: "q2",
        ...
        correctAnswer: "Твърдологическа реализация, микропрограмна реализация и програмируема логика/FPGA.",
        scoring: { type: "text" }
      },
      {
        id: "q3",
        type: "open",
        points: 1,
        prompt: "Какво е действието на следната инструкция за AVR микроконтролер и къде остава резултатът? LDI R22, 0x25",
        correctAnswer: "Зарежда 0x25 в регистър R22.",
        scoring: { type: "text" }
      },
      {
        id: "q4",
        ...
        correctAnswer: "Фон Нойманова, Харвардска и модифицирана Харвардска архитектура.",
        scoring: { type: "text" }
      },
      {
        id: "q5",
        ...
        correctAnswer: "Класическата Харвардска архитектура има отделни памети и шини за програма и данни. Модифицираната позволява по-гъвкав достъп. Предимства: паралелен достъп и по-висока скорост. Недостатъци: по-голяма сложност и цена.",
        scoring: { type: "text" }
      },
      {
        id: "q6",
        ...
        correctAnswer: "CPU ядро, Flash, SRAM, EEPROM, I/O портове, таймери/броячи, прекъсвания, USART, SPI, аналогов компаратор, Watchdog и генератор/осцилатор.",
        scoring: { type: "text" }
      },
      {
        id: "q7",
        type: "open",
        points: 1,
        prompt: "За какво служи статусният (флаговият) регистър в процесорното ядро? При какви случаи се променят стойностите на битовете му?",
        correctAnswer: "Пази флагове за резултата от операции; битовете се променят при аритметични, логически, сравнителни, премествателни и някои контролни инструкции.",
        scoring: { type: "text" }
      },
      {
        id: "q8",
      ...
      },
      {
        ...
        correctAnswer: "Интегрира CPU, памет и периферия в един чип. Предимства: ниска цена, малки размери, ниска консумация. Недостатъци: ограничени ресурси и производителност.",
        scoring: { type: "text" }
      },
      {
        id: "q10",
        type: "open",
        points: 1,
        prompt: "Представете шестнадесетичния запис на десетичното число 713 (да се представи писмено преобразуването).",
        correctAnswer: "71310 = 2C916.",
        scoring: { type: "text" }
      },
      {
        id: "q11",
        type: "open",
        points: 2,
        prompt: "Какъв ще е резултатът в регистър R18 след изпълнение на следния програмен запис? 1) LDI R18, 0x7A 2) SWAP R18",
        correctAnswer: "След LDI R18 = 0x7A. След SWAP R18 = 0xA7.",
        scoring: { type: "text" }
      },
      {
        id: "q12",
        type: "open",
        points: 5,
        prompt: "Какви крайни резултати се получават в регистри R17 и R24 след изпълнение на програмата? 1) LDI R17, 0b01011011 2) LDI R24, 0xA5 3) ADD R24, R17 4) OR R24, R17 5) EOR R17, R24 6) AND R24, R17",
        correctAnswer: `R17 = 0b01011011 = 0x5B
R24 = 0xA5
ADD -> R24 = 0x00
OR -> R24 = 0x5B
EOR -> R17 = 0x00
